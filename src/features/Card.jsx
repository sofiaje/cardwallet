...
const Card = ({ cardholder, cardNumber, isActive, expireYear, expireMonth, vendor, i }) => {
    ...
    return ( 
        <div className={`${classes.card} card`} onClick={() => {dispatch(activateCard(i))} }>
            <div>
            ...
            <div>
                ...
                {!isActive && <button className={classes.hiddenBtn} onClick={(e) => { btnClickHandler(e, i) }}>
